...
public class Init {
    ...
    public void addDataToEducationalPlans() {
        ...
        for (Person persons : personList) {
            String request = "INSERT INTO t_educational_plans (group_name) VALUES (?)";
    ...
    public void addDataToDB() {
        ...
        for (Person persons : personList) {
            String requestStudents = "INSERT INTO t_students (name, family, age, group_name) VALUES (?, ?, ?, ?); ";
            count += 1;
...
//                statement1.setInt(1, count);
                statement1.setString(1, persons.getName());
                statement1.setString(2, persons.getFamily());
                statement1.setInt(3, persons.getAge());
                statement1.setInt(4, persons.getGroup());
            ...
            String requestStudentGrades = "INSERT INTO t_student_grades (physics, mathematics, rus, literature, geometry, informatics) VALUES (?, ?, ?, ?, ?, ?)";
...
//                statement2.setInt(1, count);
                statement2.setInt(1, persons.getPhysics());
                statement2.setInt(2, persons.getMathematics());
                statement2.setInt(3, persons.getRus());
                statement2.setInt(4, persons.getLiterature());
                statement2.setInt(5, persons.getGeometry());
                statement2.setInt(6, persons.getInformatics());
